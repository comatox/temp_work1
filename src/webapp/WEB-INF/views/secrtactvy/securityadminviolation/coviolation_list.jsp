...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    gridUtil = new GridUtil({
      url: "/api/secrtactvy/securityAdminViolation/coViolation/list"
      , isPaging: true
      , gridOptions: {
        colData: [
          {
        ...
        , onRowClicked: function ({originRowData}) {
          $.esutils.href("/secrtactvy/securityadminviolation/coviolation/detail", {scDocNo: originRowData.scDocNo});
        }
      },
      search: {
        formId: "securityForm"
