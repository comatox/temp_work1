...
<script type="text/javascript">
  ...
  const onCellSelectCallback = ({originRowData}) => {
    $.esutils.href("/sysmanage/board/faq/detail", {boardNo: originRowData.boardNo})
  }
  ...
  const boardInsert = function () {
    ...
    formData.setAttribute('action', global.contextPath + '/sysmanage/board/faq/request');
        ...
        <div id="content_area">
            <div id="contentsArea">
                ...
                <div id="realContents">
                    ...
                    <form id="faqListForm" name="faqListForm" method="post" onsubmit="return false;">
