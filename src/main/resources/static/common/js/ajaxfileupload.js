...
*/
    createUploadForm: function(id, fileElementId, data, fileElementArr)
	{
		//create form	
    	/*
		var formId = 'jUploadForm' + id;
		...
		*/
		...
		if(fileElementArr.length > 0) {
			for(var i=0; i<fileElementArr.length; i++) {
				var fileFieldId = fileElementArr[i];
				var fileId = 'jUploadFile' + fileFieldId;
				
				var oldElement = jQuery('#' + fileFieldId);
				var newElement = jQuery(oldElement).clone();
				jQuery(oldElement).attr('id', fileId);
				jQuery(oldElement).before(newElement);
				jQuery(oldElement).appendTo(form);
    ...
    ajaxFileUpload: function(s) {
        ...
        var form = jQuery.createUploadForm(id, s.fileElementId, (typeof(s.data)=='undefined'?false:s.data), s.fileElementArr);
