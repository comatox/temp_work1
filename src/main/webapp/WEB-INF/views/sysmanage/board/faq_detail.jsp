...
<script type="text/javascript">
  ...
  const setRead = function (boardNo) {
    $.esutils.postApi('/api/sysmanage/faq/readUp', {boardNo}, (response) => {
  ...
  const insertReply = function () {
    $.esutils.href("/sysmanage/board/faq/reply", {boardNo});
  };
  ...
  const boardModify = function () {
    ...
    $.esutils.href("/sysmanage/board/faq/modify", {boardNo});
  };
  ...
  const boardDelete = function () {
    ...
    $.esutils.postApi('/api/sysmanage/faq/delete', {boardNo}, (response) => {
      console.log("success", response);
      alert("삭제되었습니다.");
    }, {});
        ...
        <div id="content_area">
            <div id="contentsArea">
                ...
                <div id="realContents">
                    ...
                    <form id="faqDetailForm" name="faqDetailForm" method="post">
