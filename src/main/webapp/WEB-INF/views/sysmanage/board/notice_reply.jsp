...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    if (upBoardNo) {
      $.esutils.renderData(
          "noticeReplyForm",
          `/api/sysmanage/notice/detail/\${upBoardNo}`,
          (data) => {
  ...
  const noticeSave = function () {
    ...
    const formObject = document.getElementById('noticeReplyForm');

    $.esutils.multipartSubmit(
        '/api/sysmanage/notice/reply',
        formObject,
        function (formData) {
  ...
  const validationCheck = function () {
    ...
    document.noticeReplyForm.content.value = CKEDITOR.instances.ir1.getData();
    document.noticeReplyForm.contentUrl.value = "<%--<%=setUrl%>--%>";
        ...
        <div id="content_area">
            <div id="contentsArea">
                ...
                <div id="realContents">
                    ...
                    <form id="noticeReplyForm" name="noticeReplyForm" method="post" enctype="multipart/form-data">
