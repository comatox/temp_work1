...
<script type="text/javascript">
  ...
  const faqSave = function () {
    ...
    const formObject = document.getElementById('faqRequestForm');

    $.esutils.multipartSubmit(
        '/api/sysmanage/faq/request',
        formObject,
        function (formData) {
  ...
  const validationCheck = function () {
    ...
    document.faqRequestForm.content.value = CKEDITOR.instances.ir1.getData();
        ...
        <div id="content_area">
            <div id="contentsArea">
                ...
                <div id="realContents">
                    ...
                    <form id="faqRequestForm" name="faqRequestForm" method="post" enctype="multipart/form-data">
