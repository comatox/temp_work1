...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    gridUtil = new GridUtil({
      url: "/api/secrtactvy/securityAdminViolation/ioViolation/sec/list"
      , isPaging: true
      , gridOptions: {
        colData: [
          {
        ...
        , onRowClicked: function ({originRowData}) {
          $.esutils.href("/secrtactvy/securityadminviolation/ioviolationsec/detail", {scIoDocNo: originRowData.scIoDocNo});
        }
      },
      search: {
        formId: "formGrid"
