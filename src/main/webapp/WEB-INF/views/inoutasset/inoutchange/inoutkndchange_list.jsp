...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    gridUtil = new GridUtil({
      ...
      search: {
        formId: "formGrid"
        , buttonId: "searchBtn"
        , beforeSend: data => ({...data, outcompanyknd: "1", searchPartnerNm: $("[name=searchOutcompanyknd]").val() === "3" ? $("[name=searchForeignComp]").val() : $("[name=searchDeptNm]").val()})
      }
    });
  ...
  function fn_view({inoutApplNo}) {
    $.esutils.href("/inoutasset/inoutchange/inoutkndchange/detail", {inoutApplNo});
  }
</script>
<div id="search_area">
    <!-- 검색 -->
