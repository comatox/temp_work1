...
b.fn.jqGrid=function(f){if("string"==typeof f){var e=b.jgrid.getAccessor(b.fn.jqGrid,f);if(!e)throw"jqGrid - No such method: "+f;var c=b.makeArray(arguments).slice(1);return e.apply(this,c)}return this.each(function(){if(!this.grid){var d=b.extend(!0,{
	useMultiRow:true,	// 다중 행 추가 허용 여부
	rowAdded:false,		// 행이 추가되었는지 저장하는 변수
	selectedRow:-1,		// 선택한 row의 id 저장용 변수
	selectedCol:-1,		// 선택한 row의 id 저장용 변수
	rowIdx:0,			// 신규 row의 id 생성용 변수
	formName:"grids",	// VO를 담을 객체명 (GridForm에 선언된 변수명)
	saveUrl:"",			// 저장 url
	deleteUrl:"",		// 삭제 url
	searchFormId:"",	// 조회 조건을 갖고 있는 id	
	url:"",height:150,page:1,rowNum:20,rowTotal:null,records:0,pager:"",pgbuttons:!0,pginput:!0,colModel:[],rowList:[],colNames:[],sortorder:"asc",sortname:"",datatype:"xml",mtype:"GET",altRows:!1,selarrrow:[],savedRow:[],shrinkToFit:!0,xmlReader:{},jsonReader:{},
...
null})}}}})};b.jgrid.extend({
	setUseMultiRow:function(flag) {
		return this.each(function(){
			var e=this;
			e.p.useMultiRow = flag;
		})
	},
	getUseMultiRow:function() {
		var flag = true;
		this.each(function () {
			flag = this.p.useMultiRow;
		});
		return flag;
	},
	setRowAdded:function(flag) {
		return this.each(function(){
			var e=this;
			e.p.rowAdded = flag;
		})
	},
	getRowAdded:function() {
		var flag = true;
		this.each(function () {
			flag = this.p.rowAdded;
		});
		return flag;
	},
	setSelectedRow:function(iRow) {
		return this.each(function(){
			var e=this;
			e.p.selectedRow = iRow;
		})
	},
	getSelectedRow:function() {
		var sRow = -1;
		this.each(function () {
			sRow = this.p.selectedRow;
		});
		return sRow;
	},
	setSelectedCol:function(iCol) {
		return this.each(function(){
			var e=this;
			e.p.selectedCol = iCol;
		})
	},
	getSelectedCol:function() {
		var sCol = -1;
		this.each(function () {
			sCol = this.p.selectedCol;
		});
		return sCol;
	},
	setRowIdx:function(idx) {
		return this.each(function(){
			var e=this;
			e.p.rowIdx = idx;
		})
